...
public class List_Formulario extends javax.swing.JFrame {
    ...
    public Date StringToDate(String data) {
        try {
            ...
            Logger.getLogger(List_Formulario.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ...
    private void BuscaValores() {
        ...
        DataNasc = StringToDate(jtfData.getText());
    ...
    public void preencherCampos() {
        ...
        jtfData.setText(model.getValueAt(row, 2).toString());
    }
    ...
    private void Listar(String orderBy) {
        ...
        try {
            String sql = "SELECT Formulario.codigo, Paciente.nome, DATE_FORMAT(data, '%d/%m/%Y') as data, resultado1, resultado2, resultado3, resultado4, resultado5, resultadofinal FROM Formulario \n"
            ...
            while (rec.next()) {
                ...
                String resultadofinal = rec.getString("resultadofinal");

                modelo.addRow(new Object[]{codigo, nome, data, resultadofinal});
            }
    ...
    private void jbIncluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbIncluirMouseClicked
        Form_Formulario mnt_Formulario = new Form_Formulario();
        mnt_Formulario.setVisible(true);
